...
class MultiAgentSync_call(MultiAgentEnv):
    ...
    def _get_obs(self):
        ...
        return {
            "agent1": {
                ...
                #"otheragent0": 0,#self.agent2_pos[0],
            ...
            "agent2": {
                ...
                #"otheragent0": 0,#self.agent1_pos[0],
...
### single task ###
class MultiAgentSing_call(MultiAgentEnv):
    def __init__(self, config=None):
        """Config takes in width, height, and ts"""
        config = config or {}
        # Dimensions of the grid.
    ...
    def render_image(self):
        ...
        draw.text((170, text_y_position - 10), text, font=font, fill="black")
        draw.text((30,10),str(self.agent1_R), font = font, fill = "red")
        draw.text((290,10),str(self.agent2_R), font = font, fill = "blue")
        # Move text information to the bottom
        self.draw_event_text(
            draw, self.events["agent1"], (30, text_y_position), font, "red"
        )
