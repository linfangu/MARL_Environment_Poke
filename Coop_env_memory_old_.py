...
class MultiAgentSync_memory(MultiAgentEnv):
    ...
    def _get_obs(self):
        ...
        return {
            "agent1": {
                "nosepoke0": self.poke_coords1[0] if self.agent1_NP_observed else 3,
                "water0": self.water_coords1[0],
                "self0": self.agent1_pos[0],
                "otheragent0": self.agent2_pos[0],
                "otherpoke0": self.poke_coords2[0],
                "nosepoke1": self.poke_coords1[1] if self.agent1_NP_observed else 3,
            ...
            "agent2": {
                "nosepoke0": self.poke_coords2[0] if self.agent2_NP_observed else 3,
                "water0": self.water_coords2[0],
                "self0": self.agent2_pos[0],
                "otheragent0": self.agent1_pos[0],
                "otherpoke0": self.poke_coords1[0],
                "nosepoke1": self.poke_coords2[1] - 4  if self.agent2_NP_observed else 3,
